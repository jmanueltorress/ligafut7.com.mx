...
<template>
  <footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 cont-footer">
...
export default {
  data() {
    return {
      leagueName: 'Liga de Futbol Uruguayo - San Felipe, Gto',
      // contactEmail: 'contacto@liga-futbol.com',
